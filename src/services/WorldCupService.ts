...
export class WorldCupService {
  /**
   * Subscribes to the live World Cup matching data node synced via Firebase functions
   */
  static subscribeLiveMatches(onUpdate: (matches: MatchScore[]) => void) {
    const ref = database().ref('worldcup/matches');
