  ...
  return (
    <div className="h-screen-safe relative overflow-hidden bg-[#1a293d]">
      ...
      <div className="absolute inset-0 z-10 flex justify-center">
        <div className="relative w-full sm:max-w-[320px] h-full flex flex-col">
        {/* Top bar */}
        <div className="flex items-center justify-between px-5 sm:px-2 pt-4">
          <button
        ...
        {process.env.NEXT_PUBLIC_AD_SLOT_LOBBY && (
          <div className="px-6 sm:px-2 mb-4 w-full">
            <AdSlot adSlot={process.env.NEXT_PUBLIC_AD_SLOT_LOBBY} format="rectangle" />
          </div>
        )}

        {/* Buttons */}
        <div className="px-6 sm:px-2 pb-8 flex flex-col gap-3 w-full">
          {error && (
